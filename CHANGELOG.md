...
### Added
- 知识领域从 34 个扩展到 43 个，新增 9 个完整领域三件套（学习文档、练习册、面试题）与客观题题库：
  - 基础层：F08 数据结构与算法、F09 设计模式与软件工程基础
  - 工程化层：E13 前端部署与运维（SRE）、E14 前端包管理与供应链安全
  - 架构层：A10 前端可视化与图形架构、A11 Serverless / Edge 架构、A12 前端数据工程
  - 领导力层：L07 技术品牌与社区影响力、L08 技术治理与变革管理
- 客观题题库从 495 题扩展到 585 题，覆盖全部 43 个领域。
- 更新 `SelfAssessment.vue`、`LearningDashboard.vue`、`LearningPath.vue`、`ProgressTracker.vue`、`KnowledgeGraph.vue` 以支持 43 领域。
- 更新 `docs/STYLE-GUIDE.md`、同步脚本、侧边栏生成脚本以支持新编号体系。
- 更新 README、知识依赖图、学习路线、标签体系以反映 43 领域。
