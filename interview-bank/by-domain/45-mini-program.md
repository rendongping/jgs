...
> 本题库共收录 **55** 道面试题（基础 12 / 进阶 20 / 深入 16 / 架构 7）。
...
**岗位层级**：高级
**面试知识域**：小程序
**标签**：微信小程序、生命周期、页面、App
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序中 App 生命周期和页面生命周期的主要方法，以及它们之间的关系。
...
**岗位层级**：高级
**面试知识域**：小程序
**标签**：微信小程序、setData、性能、数据绑定
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序 `setData` 的作用、原理和使用注意事项。

**参考答案**：
`setData` 是小程序框架提供的方法，用于将数据从逻辑层发送到视图层，实现数据绑定和界面更新。
...
**岗位层级**：高级
**面试知识域**：小程序
**标签**：微信小程序、组件化、自定义组件、开发
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序中组件化开发的方式和自定义组件的基本概念。
...
**题目描述**：
请说明小程序中 rpx 的原理，以及它与 px、rem 的区别。

**参考答案**：
rpx（responsive pixel）是微信小程序推出的自适应单位。
...
**岗位层级**：初级
**面试知识域**：小程序
**标签**：微信小程序、登录、wx.login、openid、session
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序的登录流程，以及前端在其中扮演的角色。
...
**岗位层级**：初级
**面试知识域**：小程序
**标签**：微信小程序、授权、隐私、getUserProfile
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序用户授权机制的变化，以及如何合理引导用户授权。
...
**岗位层级**：初级
**面试知识域**：小程序
**标签**：微信小程序、storage、本地存储、区别
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序的 `wx.setStorage` 与 Web 端的 localStorage/sessionStorage 的区别。

**参考答案**：
小程序 Storage 与 Web Storage 区别：
...
**岗位层级**：专家
**面试知识域**：小程序
**标签**：微信小程序、自定义组件、渲染、机制
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序自定义组件的渲染机制和关键特性。
...
**岗位层级**：专家
**面试知识域**：小程序
**标签**：微信小程序、启动性能、优化、冷启动
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明优化微信小程序冷启动性能的主要手段。
...
**岗位层级**：专家
**面试知识域**：小程序
**标签**：跨平台、Taro、uni-app、小程序
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明使用 Taro、uni-app 等跨平台框架开发小程序的优缺点，以及选择建议。
...
**岗位层级**：高级
**面试知识域**：小程序
**标签**：微信小程序、setData、性能、优化
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明在小程序开发中，常见的 setData 性能问题及优化方法。
...
**题目描述**：
请说明在微信小程序中实现一个字段多、校验复杂、可动态增删的表单页面的方案。
...
**岗位层级**：专家
**面试知识域**：小程序
**标签**：微信小程序、支付、wx.requestPayment、安全
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序支付功能的完整流程和前端注意事项。
...
**岗位层级**：专家
**面试知识域**：小程序
**标签**：微信小程序、版本更新、热更新、管理
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序的版本更新机制，以及前端如何处理新版本发布后的兼容和提示。
...
**岗位层级**：高级
**面试知识域**：小程序
**标签**：微信小程序、反编译、代码保护、安全
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明微信小程序代码反编译风险及前端防护策略。
