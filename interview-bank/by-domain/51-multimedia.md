...
> 本题库共收录 **56** 道面试题（基础 12 / 进阶 17 / 深入 20 / 架构 7）。
...
**岗位层级**：高级
**面试知识域**：多媒体
**标签**：HTML5、audio、video、媒体属性
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明 HTML5 `<audio>` 和 `<video>` 标签的常用属性。
...
**岗位层级**：高级
**面试知识域**：多媒体
**标签**：视频播放器、自定义控件、HTML5、video
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明实现一个自定义视频播放器控件的关键步骤。
...
**岗位层级**：高级
**面试知识域**：多媒体
**标签**：MSE、Media Source Extensions、流媒体、DASH、HLS
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请解释 MSE 的概念及其在流媒体播放中的作用。
...
**岗位层级**：高级
**面试知识域**：多媒体
**标签**：WebRTC、RTCPeerConnection、RTCDataChannel、实时通信
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明 WebRTC 的核心组件及其作用。
...
**岗位层级**：初级
**面试知识域**：多媒体
**标签**：屏幕捕获、getDisplayMedia、getUserMedia、MediaStream
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器中获取摄像头画面和屏幕共享的方法。
...
**岗位层级**：初级
**面试知识域**：多媒体
**标签**：Canvas、video、帧处理、图像处理
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明如何使用 Canvas 对视频帧进行处理。
...
**岗位层级**：初级
**面试知识域**：多媒体
**标签**：Web Audio API、音频处理、可视化、合成
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明 Web Audio API 的概念和常见应用场景。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：音频可视化、Web Audio API、Canvas、频谱
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明实现音频可视化（波形图/频谱图）的思路。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：录音、MediaRecorder、音频、导出
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器端录音并导出为音频文件的方案。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：视频剪辑、浏览器、Canvas、ffmpeg、时间轴
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器端实现基础视频剪辑功能的技术方案。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：全景视频、VR、WebGL、Three.js、Equirectangular
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器端实现 360 度全景视频播放的方案。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：多媒体、兼容性、格式、canPlayType、降级
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器中视频/音频格式兼容性的处理策略。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：大文件上传、分片、断点续传、Blob
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请说明浏览器端大文件（如视频）上传的方案。
...
**岗位层级**：专家
**面试知识域**：多媒体
**标签**：音视频同步、A/V Sync、多媒体
**出现频率**：高频
**预计回答时长**：5-8 分钟

**题目描述**：
请解释音视频同步的概念及前端保证同步的方法。
